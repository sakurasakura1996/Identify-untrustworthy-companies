...
class BaseModel:
    ...
    def model_train(self, model, params, seed, early_stop=200):
        ...
        """
        if model == 'LGB':
            oof, predictions, feature_importance_df, score, max_depth, num_leaves = self._lgb_model(params, seed, early_stop)
        return oof, predictions, feature_importance_df, score, max_depth, num_leaves


    def _lgb_model(self, params, seed, early_stop=200):
        """
        使用LightGBM进行五折交叉训练
        @param: params:参数
        ...
        return oof, predictions, feature_importance_df, roc_auc_score(target,oof), params['max_depth'], params['num_leaves']
...
for i in range(10, 14):
    ...
    for j in num_leave:
        params['max_depth'] = i
        params['num_leaves'] = j
        oof, pred, feat_importance ,score, max_depth, num_leaves = model.model_train('LGB', params, seed=10000)
        if score > best_score:
            best_score = score
...
print("best max_depth is"+str(best_max_depth))
print("best num_leaves is"+str(best_num_leaves))
